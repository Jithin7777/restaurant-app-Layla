    ...
    <section className="w-full py-16 min-h-screen bg-black px-4 sm:px-8 md:px-16 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:px-40 relative z-10">
        <div className="w-full">
          <div className="mx-auto overflow-hidden rounded-tr-[100px] sm:rounded-tr-[165.5px] h-36 w-36 sm:h-60 sm:w-60 lg:h-60 lg:w-60 xl:h-80 xl:w-80">
            <img
        ...
        <div className="w-full">
          <div className="overflow-hidden rounded-full h-36 w-36 sm:h-60 sm:w-60 lg:h-60 lg:w-60 xl:h-80 xl:w-80 mx-auto">
            <img
        ...
        <div className="w-full">
          <div className="relative z-10 overflow-hidden h-36 w-36 sm:h-60 sm:w-60 lg:h-60 lg:w-60 xl:h-80 xl:w-80 mx-auto rounded-tr-[100px] sm:rounded-tr-[165.5px]">
            <img
